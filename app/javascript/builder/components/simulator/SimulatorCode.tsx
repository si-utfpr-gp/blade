...
export interface SimulatorCodeProps {
  jsCode: string
  tsCode: string
}

export default function SimulatorCode({ jsCode, tsCode }: SimulatorCodeProps) {
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex border-b border-border bg-muted/20">
        ...
        <button
          onClick={() => navigator.clipboard.writeText(codeLang === "js" ? jsCode : tsCode)}
      ...
      <pre className="flex-1 overflow-auto p-3 text-[11px] font-mono leading-relaxed bg-foreground/[0.02]">
