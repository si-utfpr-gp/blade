...
export interface SimulatorTabsProps {
  activeTab: string
...
const tabs: { id: Tab; label: string; icon: ReactNode }[] = [
  { id: "trace", label: "Teste de Mesa", icon: <Table2 className="w-3.5 h-3.5" /> },
  { id: "explain", label: "Explicação", icon: <Sparkles className="w-3.5 h-3.5" /> },
